...
def compute_scores(score_func, base_events, children, target_event_idx,factual):
    results = []
...
class MCTS(object):
    ...
    def mcts_rollout(self, tree_node): # 
        ...
        if len(tree_node.children) != tree_coalition: #問題はここ
            ...
            rewards = compute_scores(self.score_func, self.base_events, tree_node.children, self.event_idx,self.factual)
            # import ipdb; ipdb.set_trace()
...
class SubgraphXTG(BaseExplainerTG):
    ...
    def _set_candidate_weights(self, event_idx):
        ...
        from Xmethods.codes.tgnnexplainer.method.tg_score import _set_tgat_data
    ...
    def __call__(self, all_events = None,node_idxs: Union[int, None] = None, event_idxs: Union[int, None] = None,sparsity: Union[float, None] = None, return_dict=None, device=None):
        ...
        for i, event_idx in enumerate(event_idxs): 
            ...
            self.max_candidates = num_candidates 
