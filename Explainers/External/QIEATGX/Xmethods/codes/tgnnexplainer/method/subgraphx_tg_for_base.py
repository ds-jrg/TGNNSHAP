...
from tgnnexplainer.xgraph.method.base_explainer_tg_for_tgnn import BaseExplainerTG
...
class SubgraphXTG(BaseExplainerTG):
    ...
    def __init__(self,num_candiates, model, model_name: str, explainer_name: str, dataset_name: str, all_events: DataFrame,  explanation_level: str, device, 
        ...
        super(SubgraphXTG, self).__init__(num_candiates=num_candiates,
                                          model=model, 
    ...
    def __call__(self, node_idxs: Union[int, None] = None, event_idxs: Union[int, None] = None,sparsity: Union[float, None] = None, return_dict=None, device=None, next_candidates=None, prior_can=None,new_start_candidates=None,new_end_candidates=None):
        """
        Args:
        ...
        for i, event_idx in enumerate(event_idxs):
            ...
            # self.max_candiates = num_candidates
