...
class BaseExplainerTG(object):
    def __init__(self, sparsity: float,model: Union[TGAN, None], model_name: str, explainer_name: str, dataset_name: str, all_events: str, explanation_level: str, device, 
    ...
    def find_candidates(self, target_event_idx):
        ...
        if self.model_name in ['tgat', 'tgn']:
            ...
            # threshold_num = int(self.max_candiates)
        ...
        # threshold_num = max(1,int(self.sparsity*len(candidate_events)))
        # threshold_num = 20
        # print('max_candiate:',threshold_num)
        # exit()
